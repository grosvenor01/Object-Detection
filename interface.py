...
with st.form("parameters"):
    ...
    address_camera1 = st.text_input("Adresse caméra 1 ", value="http://192.168.137.250:8080/video")
    address_camera2 = st.text_input("Adresse caméra 2 ", value="http://192.168.137.199:8080/video")
